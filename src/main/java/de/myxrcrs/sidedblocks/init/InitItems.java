...
public class InitItems {
    ...
    public static final RegistryObject<BlockItem> STRIPPED_BIRCH_LOG_BRICKS = ITEMS.register("stripped_birch_log_bricks", ()->new BlockItem(InitBlocks.STRIPPED_BIRCH_LOG_BRICKS.get(),new Item.Properties().group(SidedBlocks.ITEM_GROUP)));
    public static final RegistryObject<BlockItem> STRIPPED_DARK_OAK_LOG_BRICKS = ITEMS.register("stripped_dark_oak_log_bricks", ()->new BlockItem(InitBlocks.STRIPPED_DARK_OAK_LOG_BRICKS.get(),new Item.Properties().group(SidedBlocks.ITEM_GROUP)));
    ...
    public static final RegistryObject<BlockItem> CLASSROOM_CONCRETE_POLISHED_ANDESITE_POLISHED_ANDESITE_POLISHED_GRANITE = ITEMS.register("classroom_concrete_polished_andesite_polished_andesite_polished_granite", ()->new BlockItem(InitBlocks.CLASSROOM_CONCRETE_POLISHED_ANDESITE_POLISHED_ANDESITE_POLISHED_GRANITE.get(),new Item.Properties().group(SidedBlocks.ITEM_GROUP)));
    public static final RegistryObject<BlockItem> STRIPPED_BIRCH_LOG_BRICKS_WHITE_CONCRETE_STRIPPED_DARK_OAK_LOG = ITEMS.register("stripped_birch_log_bricks_white_concrete_stripped_dark_oak_log", ()->new BlockItem(InitBlocks.STRIPPED_BIRCH_LOG_BRICKS_WHITE_CONCRETE_STRIPPED_DARK_OAK_LOG.get(),new Item.Properties().group(SidedBlocks.ITEM_GROUP)));
    public static final RegistryObject<BlockItem> STRIPPED_OAK_LOG_BRICKS_WHITE_CONCRETE_SANDSTONE_TOP = ITEMS.register("stripped_oak_log_bricks_white_concrete_sandstone_top", ()->new BlockItem(InitBlocks.STRIPPED_OAK_LOG_BRICKS_WHITE_CONCRETE_SANDSTONE_TOP.get(),new Item.Properties().group(SidedBlocks.ITEM_GROUP)));
    public static final RegistryObject<BlockItem> TEST_BLOCK = ITEMS.register("test", ()->new BlockItem(InitBlocks.TEST_BLOCK.get(),new Item.Properties().group(SidedBlocks.ITEM_GROUP)));
}